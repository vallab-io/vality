          ...
          <div className="mt-12 space-y-8">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Vallab(이하 "회사"라 함)는 Vality 서비스 제공을 위하여 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 개인정보보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
              </p>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 mt-4 text-muted-foreground">
                ...
                <li>서비스 이용 기록: 회원 탈퇴 시까지 (단, 관계 법령에 따라 일정 기간 보관이 필요한 경우 해당 기간)</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                회사는 정보주체의 개인정보를 제1항(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다. 현재 회사는 정보주체의 개인정보를 제3자에게 제공하고 있지 않습니다.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                회사는 위탁계약 체결 시 개인정보 보호법 제26조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적·관리적 보호조치, 재위탁 제한 등에 관한 사항을 계약서 등 문서에 명시합니다.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                위 권리 행사는 회사에 대해 서면, 전자우편 등을 통하여 하실 수 있으며, 회사는 관련 법령에 따라 적절한 조치를 취하겠습니다.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                회사는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 해당 개인정보를 파기합니다. 파기의 절차 및 방법은 다음과 같습니다.
              </p>
              <ul className="list-disc list-inside space-y-2 mt-4 text-muted-foreground">
                <li>파기절차: 정보주체가 입력한 정보는 목적 달성 후 별도의 DB에 옮겨져 보관기간 및 관계 법령에 따라 일정기간 저장된 후 파기됩니다.</li>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 문의사항에 응대하기 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
              </p>
              <div className="mt-4 p-4 bg-muted/50 rounded-lg text-muted-foreground">
                <p>이메일: support@vality.io</p>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                이 개인정보처리방침은 2025년 1월부터 적용되며, 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항을 공지사항을 통하여 고지할 수 있습니다.
              </p>
            </section>
          </div>
        </div>
